...
$(document).ready(function () {
    ...
    $('#mnureports').addClass('nav-active');
    $('#mnureportsnotification').addClass('active');

    //$('#ctl00_CntAdminEx_Body_grdReportData')
    //    .prepend($("<thead></thead>")
    //    .append($(this).find("#ctl00_CntAdminEx_Body_grdReportData tr:first")))
    //    .dataTable();
