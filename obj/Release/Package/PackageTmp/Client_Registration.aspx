...
<asp:Content ID="contChild_Header" ContentPlaceHolderID="contHeadContent" runat="server">
    ...
    <%--  <script type="text/javascript">
        $(document).ready(function () {
            $(<%=lbox_comm_dealt.ClientID%>).SumoSelect({ selectAll: true, okCancelInMulti: true });
         });
    </script>--%>
</asp:Content>
                                    ...
                                    <div class="form-horizontal adminex-form">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <asp:TextBox ID="txtphnno" name="txtphnno" runat="server" CssClass="form-control tooltips" data-trigger="hover"
                                                            MaxLength="10" data-toggle="tooltip" title="" placeholder="Contact number" data-original-title="Contact person number"></asp:TextBox>
                                                        <asp:RegularExpressionValidator ID="revContNum4" runat="server"
                                                            ControlToValidate="txtphnno" ErrorMessage="Enter Correct Contact number!!!"
                                                    ...
                                                    <div class="col-sm-2">
                                                        <asp:TextBox ID="txtphnno2" runat="server" CssClass="form-control tooltips" data-trigger="hover"
                                                            MaxLength="10" data-toggle="tooltip" title="" placeholder="Contact number 2" data-original-title="Contact person number"></asp:TextBox>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server"
                                                            ControlToValidate="txtphnno2" ErrorMessage="Enter Correct Contact number!!!"
                                                            ValidationExpression="[6-9]{1}[0-9]{9}"></asp:RegularExpressionValidator>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-2">
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server"
                                                            ControlToValidate="txtmob" ErrorMessage="Please Enter Correct Mobile number!!!"
                                                            ValidationExpression="[6-9]{1}[0-9]{9}"></asp:RegularExpressionValidator>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2 col-sm-2 control-label">Address Line 1: </label>
                                                    <div class="col-sm-10">
                                                        <asp:TextBox ID="txtaddress" name="txtcompnm" runat="server" CssClass="form-control tooltips"
                                                            data-toggle="tooltip" title="" placeholder="House no, Street Address" data-original-title="Company Name"></asp:TextBox>
                                                    </div>

                                                </div>
                                                <%--   <div class="form-group">
                                                    <label class="col-sm-2 col-sm-2 control-label">Address Line 2: </label>
                                                    <div class="col-sm-10">
                                                        <asp:TextBox ID="txtaddress2" runat="server" CssClass="form-control tooltips"
                                                            data-toggle="tooltip" title="" placeholder="Area" data-original-title="Company Name"></asp:TextBox>
                                                    </div>
                                                </div>--%>
                                               ...
                                               <asp:TextBox ID="txtcomm_dealt" name="txtcomm_dealt" runat="server" CssClass="form-control tooltips" data-trigger="hover"
                                                    ...
                                                    <div class="col-sm-6">
                                                       <%-- <asp:ListBox ID="lbox_comm_dealt" runat="server" Font-Bold="True" SelectionMode="Multiple"
                            ...
                            <div class="adv-table nice-scroll-grid">
                                ...
                                <asp:GridView ID="grdUser" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Contact Number 2">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Address2">
                                            <ItemTemplate>
                                                <asp:Label ID="ComLocAdd2" runat="server" Text='<%# Eval("sCompanyAdd2") %>'></asp:Label>
                                            </ItemTemplate>
                                      ...
                                      <%--  <asp:TemplateField HeaderText="Predefined Img" Visible="false">
                                        ...
                                        <asp:TemplateField HeaderText="Role">
                                            ...
                                            <%-- <EditItemTemplate>
                                                ...
                                                <asp:DropDownList ID="sRole" runat="server" Font-Bold="True" AutoPostBack="True"
                                                    CssClass="form-control m-bot15">
                                                    <asp:ListItem Value="0" Text="-- Select Role --"></asp:ListItem>
                                                    <asp:ListItem Value="1" Text="ABC"></asp:ListItem>
                                                    <asp:ListItem Value="2" Text="PQR"></asp:ListItem>
