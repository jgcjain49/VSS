    ...
    public class MStoreOrderingService : System.Web.Services.WebService
    {
                                          ...
                                          bool pBlnCheckAll, int pIntPriceSorting, string pStrAccessKey)
        {
            ...
            try
            {
                ...
                {
                    if (pStrPreviousProuductsList.Trim() == "")
                        pStrPreviousProuductsList = "-1";
                ...
                if (pStrMethodAuthKey == "lkenvg5=Uu=j8@*vb@lnmej^_8476-_dok<3" && mStrConnectionStringToUse != "")
                {
                    ...
                    if (dtInserted.Rows.Count > 0)
                    {
                        ...
                        if (mIntInsertCnt == mObjOrderDetailFull.OrderDetails.Count)
                        {
                            ...
                            SendDelegatedMails(pLngTalukaId, mObjSubmissionDetails.OrderId);
                        }
                        else
                        {
        ...
        [WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)] // Make return type as json.
        public void SearchProductsBasic(long pLngTalukaId, string pStrPreviousProuductsList, bool pBlnIsRegionalSearch,
            string pStrSearchText, int pIntPriceSorting, string pStrAccessKey)
        {
            ProductsSearchResult mObjResult = new ProductsSearchResult();
            try
            {
        ...
        // ADDED BY HVB
        // To Send Delegated Mails

        public void SendDelegatedMails(long pLngTalukaId, long pLngOrderId)
        {
            ...
            mDeleObj.BeginInvoke(pLngTalukaId, pLngOrderId, mObjMailMethodDone, null);
        }

        private delegate void AsyncMethodCaller(long pLngTalId, long pLngOrdId);

        //Method that works as different machine thread.
        //If gmail denies mail sending :  https://g.co/allowaccess 
        private void SendMailInSafeMachineThread(long pLngTalukaId, long pLngOrderId)
        {
            try
            {

                DataSet dsEmailDetails = SqlHelper.ReadDataSet("SP_GetEmailDetails", GlobalVariables.SqlConnectionStringMstoreInformativeDb,
                    true, true, SqlHelper.AddInParam("@nVarTalukaId", SqlDbType.NVarChar, pLngTalukaId),
                                SqlHelper.AddInParam("@nVarOrderId", SqlDbType.NVarChar, pLngOrderId),
                                SqlHelper.AddInParam("@nVarExtraColsList", SqlDbType.NVarChar, "COALESCE(CAST(DECRYPTBYPASSPHRASE('*#_140351_HS_029081_75396_#*',ec.EC_vCharSenderPassword) as varchar(Max)),'') As [vwSenerPass]"));
                ...
                if (dsEmailDetails != null)
                {
                    ...
                    mStrCommonTopTable += "    </tr>";
                    mStrCommonTopTable += "    <tr>";
                    mStrCommonTopTable += "        <td style=\"border: 1px solid rgba(204, 204, 204, 1);font-size: small;padding: 5px;line-height: 1.5em;font-family: Georgia, 'Times New Roman', Times, serif;\">Order Details</td>";
                    mStrCommonTopTable += "        <td style=\"font-family: Georgia, 'Times New Roman', Times, serif;border-bottom: 1px solid rgba(204, 204, 204, 1);\">Order Number : <span style=\"color: rgba(0, 102, 255, 1)\">" + pLngOrderId + "</span>";
                    mStrCommonTopTable += "            <br/>";
                    mStrCommonTopTable += "            Order Date : <span style=\"color: rgba(0, 102, 255, 1)\">" + Convert.ToDateTime(dsEmailDetails.Tables[0].Rows[0]["Ord_dtOrderTime"]).ToString("dd-MMM-yyyy") + "</span>";
                    mStrCommonTopTable += "            <br/>";
                    mStrCommonTopTable += "            Order Time : <span style=\"color: rgba(0, 102, 255, 1)\">" + Convert.ToDateTime(dsEmailDetails.Tables[0].Rows[0]["Ord_dtOrderTime"]).ToString("hh:mm:ss tt") + "</span>";
                    mStrCommonTopTable += "        </td>";
                    mStrCommonTopTable += "    </tr>";
                    mStrCommonTopTable += "    <tr style=\"background-color:rgba(204,204,204,0.5);\">";
                    mStrCommonTopTable += "        <td style=\"border: 1px solid rgba(204, 204, 204, 1);font-size: small;padding: 5px;line-height: 1.5em;font-family: Georgia, 'Times New Roman', Times, serif;\">Contatct Details</td>";
                    mStrCommonTopTable += "        <td style=\"font-family: Georgia, 'Times New Roman', Times, serif;\">Contact Person : <span style=\"color: rgba(0, 102, 255, 1)\">" + Convert.ToString(dsEmailDetails.Tables[0].Rows[0]["Ord_nVcharContactName"]) + "</span>";
                    mStrCommonTopTable += "	        <br/>";
                    mStrCommonTopTable += "            Phone : <span cstyle=\"color: rgba(0, 102, 255, 1)\">" + Convert.ToString(dsEmailDetails.Tables[0].Rows[0]["Ord_nVcharContactPhoneNumber"]) + "</span>";
                    mStrCommonTopTable += "            <br/>";
                    mStrCommonTopTable += "            Email : <span style=\"color: rgba(0, 102, 255, 1)\">" + Convert.ToString(dsEmailDetails.Tables[0].Rows[0]["Ord_vCharContactEmailAddress"]) + "</span>";
                    mStrCommonTopTable += "        </td>";
                    mStrCommonTopTable += "    </tr>";
                    mStrCommonTopTable += "    <tr>";
                    ...
                    mStrCommonTopTable += "            <br/>";
                    mStrCommonTopTable += Convert.ToString(dsEmailDetails.Tables[0].Rows[0]["Ord_nVcharContactAddress1"]).Replace(",", ",<br/>");
                    mStrCommonTopTable += "        </td>";
                    mStrCommonTopTable += "        <td style=\"border: 1px solid rgba(204, 204, 204, 1);font-size: small;padding: 5px;line-height: 1.5em;font-family: Georgia, 'Times New Roman', Times, serif;\">";
                    mStrCommonTopTable += "	        Secondary Address : ";
                    mStrCommonTopTable += "            <br/>";
                    mStrCommonTopTable += Convert.ToString(dsEmailDetails.Tables[0].Rows[0]["Ord_nVcharContactAddress2"]).Replace(",", ",<br/>");
                    mStrCommonTopTable += "        </td>";
                    mStrCommonTopTable += "    </tr>";
                    ...
                    foreach (DataRow drInfo in dtInformations.Rows)
                    {
                        ...
                        {
                            mStrInfoName = Convert.ToString(drArrSearchResult[2]["IM_vCharInfoName_En"]);
                            ...
                            mStrInnerOrderInfoHtml += "        <td colspan=\"5\" style=\"background-color: rgba(204, 204, 204, 0.8);padding: 3px;font-weight: bold;font-family: Georgia, 'Times New Roman', Times, serif;\">Order Summary</td>";
                            mStrInnerOrderInfoHtml += "    </tr>";
                            mStrInnerOrderInfoHtml += "    <tr>";
                            mStrInnerOrderInfoHtml += "        <td colspan=\"2\" style=\"background-color: rgba(204, 204, 204, 0.8);padding: 2px !important;font-style: italic;border: 1px solid rgba(204, 204, 204, 1);font-size: small;line-height: 1.5em;font-family: Georgia, 'Times New Roman', Times, serif;\">Product</td>";
                            mStrInnerOrderInfoHtml += "        <td style=\"background-color: rgba(204, 204, 204, 0.8);padding: 2px !important;font-style: italic;border: 1px solid rgba(204, 204, 204, 1);font-size: small;line-height: 1.5em;font-family: Georgia, 'Times New Roman', Times, serif;\">Quantity</td>";
                            ...
                            mStrInnerOrderInfoHtml += "        <td style=\"background-color: rgba(204, 204, 204, 0.8);padding: 2px !important;font-style: italic;border: 1px solid rgba(204, 204, 204, 1);font-size: small;line-height: 1.5em;font-family: Georgia, 'Times New Roman', Times, serif;\">Remark</td>";
                            mStrInnerOrderInfoHtml += "    </tr>";
                        }
                        ...
                        {
                            mStrOrderList += Convert.ToString(drArrSearchResult[iRowCnt]["OrdSub_bIntId"]) + ",";
                            if (iRowCnt % 2 == 0)
                                mStrInnerOrderInfoHtml += "    <tr>";
                            else
                            ...
                            mStrInnerOrderInfoHtml += "        <td style=\"border: 1px solid rgba(204, 204, 204, 1);font-size: small;padding: 5px;line-height: 1.5em;font-family: Georgia, 'Times New Roman', Times, serif;\">" + Convert.ToDecimal(drArrSearchResult[iRowCnt]["OrdSub_decQty"]).ToString("N3") + "</td>";
                            mStrInnerOrderInfoHtml += "        <td style=\"border: 1px solid rgba(204, 204, 204, 1);font-size: small;padding: 5px;line-height: 1.5em;font-family: Georgia, 'Times New Roman', Times, serif;\">Rs. " + Convert.ToDecimal(drArrSearchResult[iRowCnt]["OrdSub_decBasicAmt"]).ToString("N2") + "</td>";
                            mStrInnerOrderInfoHtml += "        <td style=\"border: 1px solid rgba(204, 204, 204, 1);font-size: small;padding: 5px;line-height: 1.5em;font-family: Georgia, 'Times New Roman', Times, serif;\">" + Convert.ToString(drArrSearchResult[iRowCnt]["OrdSub_nVarRemark"]) + "</td>";
                            mStrInnerOrderInfoHtml += "    </tr>";
                        }
                        ...
                        mStrInnerOrderInfoHtml += "        <td style=\"font-family: Georgia, 'Times New Roman', Times, serif;\">Rs. " + Convert.ToDecimal(dsEmailDetails.Tables[0].Rows[0]["Ord_dblTotalAmount"]).ToString("N2") + "</td>";
                        ...
                        // Add Header
                        // 
                        drArrSearchResult = dsEmailDetails.Tables[1].Select("EER_bIntInfoId = " + Convert.ToString(drInfo[0]));
                        string mStrEmailFullBody = "";
                        string mStrFooter = "";
                        if (drArrSearchResult.Length > 0)
                        {
                            mStrEmailFullBody = Convert.ToString(drArrSearchResult[0]["EC_nVarEmailHeader"]);
                            mStrFooter = Convert.ToString(drArrSearchResult[0]["EC_nVarEmailFooter"]);
                            mStrEmailFullBody = mStrEmailFullBody.Replace("[::{<AUTOSYS_CLIENT_NAME>}::]", Convert.ToString(dsEmailDetails.Tables[0].Rows[0]["Ord_nVcharContactName"]))
                                                   .Replace("[::{<AUTOSYS_ORDER_DATE>}::]", Convert.ToDateTime(dsEmailDetails.Tables[0].Rows[0]["Ord_dtOrderTime"]).ToString("MMMM dd, yyyy"))
                                                   .Replace("[::{<AUTOSYS_ORDER_TIME>}::]", Convert.ToDateTime(dsEmailDetails.Tables[0].Rows[0]["Ord_dtOrderTime"]).ToString("hh:mm:ss tt"))
                                                   .Replace("[::{<AUTOSYS_ORDER_NUMBER>}::]", pLngOrderId.ToString());
                            mStrFooter = mStrFooter.Replace("[::{<AUTOSYS_CLIENT_NAME>}::]", Convert.ToString(dsEmailDetails.Tables[0].Rows[0]["Ord_nVcharContactName"]))
                                                   .Replace("[::{<AUTOSYS_ORDER_DATE>}::]", Convert.ToDateTime(dsEmailDetails.Tables[0].Rows[0]["Ord_dtOrderTime"]).ToString("MMMM dd, yyyy"))
                                                   .Replace("[::{<AUTOSYS_ORDER_TIME>}::]", Convert.ToDateTime(dsEmailDetails.Tables[0].Rows[0]["Ord_dtOrderTime"]).ToString("hh:mm:ss tt"))
                                                   .Replace("[::{<AUTOSYS_ORDER_NUMBER>}::]", pLngOrderId.ToString());
                        ...
                        // Add Recievers
                        string mStrRecievers = Convert.ToString(dsEmailDetails.Tables[0].Rows[0]["Ord_vCharContactEmailAddress"]);
                        ...
                        mObjMailMsg.Subject = String.Format("Order reciept confirmation with order number {0} @ MStoreInda-{1} : {2}", pLngOrderId, dsEmailDetails.Tables[2].Rows[0]["TM_vCharName_En"], mStrInfoName);
                        ...
                        // Save Log
                        DataTable dtSaved = SqlHelper.ReadTable("SP_AddEmailLog", GlobalVariables.SqlConnectionStringMstoreInformativeDb, true,
                                                             SqlHelper.AddInParam("@bIntConfigId", SqlDbType.BigInt, dsEmailDetails.Tables[1].Rows[0]["EC_bIntId"]),
                                                             SqlHelper.AddInParam("@bIntInfoId", SqlDbType.BigInt, drInfo[0]),
                                                             SqlHelper.AddInParam("@nVarOrderList", SqlDbType.NVarChar, mStrOrderList),
                                                             SqlHelper.AddInParam("@nVarEmailBody", SqlDbType.NVarChar, mStrEmailFullBody),
                                                             SqlHelper.AddInParam("@vCharRecievers", SqlDbType.VarChar, mStrRecievers),
                                                             SqlHelper.AddInParam("@vCharAttachedFiles", SqlDbType.VarChar, null),
                                                             SqlHelper.AddInParam("@intEmailStatus", SqlDbType.Int, 1));

                        if (dtSaved.Rows.Count > 0)
                        {
                            if (Convert.ToInt64(dtSaved.Rows[0][0]) > 0)
                            {
                                // Log Saved
                            }
                        }
                ...
                else
                {
                    ...
                    // Emailing at order id

                    // Save Log
                    DataTable dtSaved = SqlHelper.ReadTable("SP_AddEmailLog", GlobalVariables.SqlConnectionStringMstoreInformativeDb, true,
                                                         SqlHelper.AddInParam("@bIntConfigId", SqlDbType.BigInt, dsEmailDetails.Tables[1].Rows[0]["EC_bIntId"]),
                                                         SqlHelper.AddInParam("@bIntInfoId", SqlDbType.BigInt, -1),
                                                         SqlHelper.AddInParam("@nVarOrderList", SqlDbType.NVarChar, ""),
                                                         SqlHelper.AddInParam("@nVarEmailBody", SqlDbType.NVarChar, "No Order Details Found For Order Number : " + pLngOrderId.ToString()),
                                                         SqlHelper.AddInParam("@vCharRecievers", SqlDbType.VarChar, "Error"),
                                                         SqlHelper.AddInParam("@vCharAttachedFiles", SqlDbType.VarChar, null),
