                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <asp:DropDownList ID="ddlTypeOfPayment"   runat="server" Font-Bold="True"  AutoPostBack="true" CssClass="form-control m-bot15">
                                                    ...
                                                    <asp:ListItem Value="2" Text="Credit" />                                           
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div role="form">
                        <div class="form-group">
                            <h3>Are you sure you want to delete Payment Detail?</h3>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <label class="col-sm-2 col-sm-2 control-label">Payment ID </label>
                                <div class="col-sm-10">
                            ...
                            <div class="row">
                                <div class="panel-body" style="text-align: center">
                                    <button class="btn btn-success" type="button" onserverclick="btnDeleteClient_ServerClick"
                                        ...
                                        <i class="fa fa-trash"></i>Delete Payment Detail
                                    </button>
